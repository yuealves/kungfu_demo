...
class ADOrderbookSnapshot : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.htsc.mdc.insight.model.ADOrderbookSnapshot) */ {
 public:
  ...
  static const int kPurchaseNumberFieldNumber = 46;
  ...
  static const int kPurchaseAmountFieldNumber = 47;
  ...
  static const int kRedemptionNumberFieldNumber = 48;
  ...
  static const int kRedemptionAmountFieldNumber = 49;
...
// optional int64 PurchaseNumber = 46;
inline void ADOrderbookSnapshot::clear_purchasenumber() {
  purchasenumber_ = GOOGLE_LONGLONG(0);
}
inline ::google::protobuf::int64 ADOrderbookSnapshot::purchasenumber() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.ADOrderbookSnapshot.PurchaseNumber)
  return purchasenumber_;
}
inline void ADOrderbookSnapshot::set_purchasenumber(::google::protobuf::int64 value) {
...
// optional int64 PurchaseAmount = 47;
inline void ADOrderbookSnapshot::clear_purchaseamount() {
  purchaseamount_ = GOOGLE_LONGLONG(0);
}
inline ::google::protobuf::int64 ADOrderbookSnapshot::purchaseamount() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.ADOrderbookSnapshot.PurchaseAmount)
  return purchaseamount_;
}
inline void ADOrderbookSnapshot::set_purchaseamount(::google::protobuf::int64 value) {
...
// optional int64 RedemptionNumber = 48;
inline void ADOrderbookSnapshot::clear_redemptionnumber() {
  redemptionnumber_ = GOOGLE_LONGLONG(0);
}
inline ::google::protobuf::int64 ADOrderbookSnapshot::redemptionnumber() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.ADOrderbookSnapshot.RedemptionNumber)
  return redemptionnumber_;
}
inline void ADOrderbookSnapshot::set_redemptionnumber(::google::protobuf::int64 value) {
...
// optional int64 RedemptionAmount = 49;
inline void ADOrderbookSnapshot::clear_redemptionamount() {
  redemptionamount_ = GOOGLE_LONGLONG(0);
}
inline ::google::protobuf::int64 ADOrderbookSnapshot::redemptionamount() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.ADOrderbookSnapshot.RedemptionAmount)
  return redemptionamount_;
}
inline void ADOrderbookSnapshot::set_redemptionamount(::google::protobuf::int64 value) {
