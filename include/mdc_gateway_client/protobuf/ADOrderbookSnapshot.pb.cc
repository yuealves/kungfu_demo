...
void protobuf_AssignDesc_ADOrderbookSnapshot_2eproto() {
  ...
  static const int ADOrderbookSnapshot_offsets_[46] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ADOrderbookSnapshot, purchasenumber_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ADOrderbookSnapshot, purchaseamount_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ADOrderbookSnapshot, redemptionnumber_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ADOrderbookSnapshot, redemptionamount_),
  };
...
void protobuf_AddDesc_ADOrderbookSnapshot_2eproto_impl() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "od\030- \001(\005\022\026\n\016PurchaseNumber\030. \001(\003\022\026\n\016Purc"
    "haseAmount\030/ \001(\003\022\030\n\020RedemptionNumber\0300 \001"
    "(\003\022\030\n\020RedemptionAmount\0301 \001(\003\"q\n\rADEntryD"
    "etail\022\r\n\005Level\030\001 \001(\005\022\r\n\005Price\030\002 \001(\003\022\020\n\010T"
    "otalQty\030\003 \001(\005\022\026\n\016NumberOfOrders\030\004 \001(\005\022\030\n"
    "\014OrderQtyList\030\005 \003(\005B\002\020\001B<\n\032com.htsc.mdc."
    "insight.modelB\031ADOrderbookSnapshotProtos"
    "H\001\240\001\001b\006proto3", 1573);
...
const int ADOrderbookSnapshot::kPurchaseNumberFieldNumber;
const int ADOrderbookSnapshot::kPurchaseAmountFieldNumber;
const int ADOrderbookSnapshot::kRedemptionNumberFieldNumber;
const int ADOrderbookSnapshot::kRedemptionAmountFieldNumber;
...
void ADOrderbookSnapshot::SharedCtor() {
  ...
  ::memset(&mddate_, 0, reinterpret_cast<char*>(&redemptionamount_) -
    reinterpret_cast<char*>(&mddate_) + sizeof(redemptionamount_));
  _cached_size_ = 0;
}
...
#define ZR_(first, last) do {\
  ...
  ZR_(datasource_, redemptionamount_);
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 45: {
        ...
        if (input->ExpectTag(368)) goto parse_PurchaseNumber;
        break;
      }

      // optional int64 PurchaseNumber = 46;
      case 46: {
        if (tag == 368) {
        ...
        if (input->ExpectTag(376)) goto parse_PurchaseAmount;
        break;
      }

      // optional int64 PurchaseAmount = 47;
      case 47: {
        if (tag == 376) {
        ...
        if (input->ExpectTag(384)) goto parse_RedemptionNumber;
        break;
      }

      // optional int64 RedemptionNumber = 48;
      case 48: {
        if (tag == 384) {
        ...
        if (input->ExpectTag(392)) goto parse_RedemptionAmount;
        break;
      }

      // optional int64 RedemptionAmount = 49;
      case 49: {
        if (tag == 392) {
...
void ADOrderbookSnapshot::SerializeWithCachedSizes(
  ...
  if (this->purchasenumber() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(46, this->purchasenumber(), output);
  }

  // optional int64 PurchaseAmount = 47;
  if (this->purchaseamount() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(47, this->purchaseamount(), output);
  }

  // optional int64 RedemptionNumber = 48;
  if (this->redemptionnumber() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(48, this->redemptionnumber(), output);
  }

  // optional int64 RedemptionAmount = 49;
  if (this->redemptionamount() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(49, this->redemptionamount(), output);
  }
...
::google::protobuf::uint8* ADOrderbookSnapshot::InternalSerializeWithCachedSizesToArray(
  ...
  // optional int64 PurchaseNumber = 46;
  if (this->purchasenumber() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(46, this->purchasenumber(), target);
  }

  // optional int64 PurchaseAmount = 47;
  if (this->purchaseamount() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(47, this->purchaseamount(), target);
  }

  // optional int64 RedemptionNumber = 48;
  if (this->redemptionnumber() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(48, this->redemptionnumber(), target);
  }

  // optional int64 RedemptionAmount = 49;
  if (this->redemptionamount() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(49, this->redemptionamount(), target);
  }
...
// optional int64 PurchaseNumber = 46;
void ADOrderbookSnapshot::clear_purchasenumber() {
  purchasenumber_ = GOOGLE_LONGLONG(0);
}
::google::protobuf::int64 ADOrderbookSnapshot::purchasenumber() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.ADOrderbookSnapshot.PurchaseNumber)
  return purchasenumber_;
}
void ADOrderbookSnapshot::set_purchasenumber(::google::protobuf::int64 value) {
  
  purchasenumber_ = value;
  // @@protoc_insertion_point(field_set:com.htsc.mdc.insight.model.ADOrderbookSnapshot.PurchaseNumber)
}

// optional int64 PurchaseAmount = 47;
void ADOrderbookSnapshot::clear_purchaseamount() {
  purchaseamount_ = GOOGLE_LONGLONG(0);
}
::google::protobuf::int64 ADOrderbookSnapshot::purchaseamount() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.ADOrderbookSnapshot.PurchaseAmount)
  return purchaseamount_;
}
void ADOrderbookSnapshot::set_purchaseamount(::google::protobuf::int64 value) {
  
  purchaseamount_ = value;
  // @@protoc_insertion_point(field_set:com.htsc.mdc.insight.model.ADOrderbookSnapshot.PurchaseAmount)
}

// optional int64 RedemptionNumber = 48;
void ADOrderbookSnapshot::clear_redemptionnumber() {
  redemptionnumber_ = GOOGLE_LONGLONG(0);
}
::google::protobuf::int64 ADOrderbookSnapshot::redemptionnumber() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.ADOrderbookSnapshot.RedemptionNumber)
  return redemptionnumber_;
}
void ADOrderbookSnapshot::set_redemptionnumber(::google::protobuf::int64 value) {
  
  redemptionnumber_ = value;
  // @@protoc_insertion_point(field_set:com.htsc.mdc.insight.model.ADOrderbookSnapshot.RedemptionNumber)
}

// optional int64 RedemptionAmount = 49;
void ADOrderbookSnapshot::clear_redemptionamount() {
  redemptionamount_ = GOOGLE_LONGLONG(0);
}
::google::protobuf::int64 ADOrderbookSnapshot::redemptionamount() const {
  // @@protoc_insertion_point(field_get:com.htsc.mdc.insight.model.ADOrderbookSnapshot.RedemptionAmount)
  return redemptionamount_;
}
void ADOrderbookSnapshot::set_redemptionamount(::google::protobuf::int64 value) {
  
  redemptionamount_ = value;
  // @@protoc_insertion_point(field_set:com.htsc.mdc.insight.model.ADOrderbookSnapshot.RedemptionAmount)
}
